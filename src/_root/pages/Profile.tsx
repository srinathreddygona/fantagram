...
const Profile = () => {
  ...
  const { data: isFollowingUser = false } = useIsFollowing(user.id, id || "");
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex justify-center gap-4">
            ...
            <div className={`${user.id === id && "hidden"}`}>
              <Button 
                type="button" 
                className={`shad-button_primary px-8 ${isFollowingUser ? 'bg-dark-4 text-light-1' : ''}`}
              ...
              >
                {isLoading ? (
                  <div className="flex-center gap-2">
                    ...
                    <span>{isFollowingUser ? "Unfollowing..." : "Following..."}</span>
                  </div>
                ) : (
